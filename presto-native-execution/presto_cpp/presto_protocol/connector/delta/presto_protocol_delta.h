...
struct DeltaColumn {
  std::shared_ptr<Long> id = {};
  std::shared_ptr<String> physicalName = {};
  String logicalName = {};
  TypeSignature type = {};
  bool nullable = {};
  bool partition = {};
...
struct DeltaColumnHandle : public ColumnHandle {
  ...
  bool operator<(const ColumnHandle& other) const override {
    return logicalName <
        dynamic_cast<const DeltaColumnHandle&>(other).logicalName;
  }
};
